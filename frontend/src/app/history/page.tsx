...
export default function HistoryPage() {
  ...
  const conversations = [
    {
      id: 1,
      title: 'Tìm chuyến bay Hà Nội - TP.HCM',
      preview: 'Tôi cần tìm chuyến bay từ Hà Nội đi TP.HCM vào ngày 15/12...',
      date: '2 giờ trước',
      messageCount: 12,
    },
    {
      id: 2,
      title: 'Hỏi về hành lý ký gửi',
      preview: 'Cho tôi hỏi về quy định hành lý ký gửi của hãng...',
      date: 'Hôm qua',
      messageCount: 8,
    },
    {
      id: 3,
      title: 'Đổi lịch bay',
      preview: 'Tôi muốn đổi lịch bay từ ngày 20 sang ngày 22...',
      date: '3 ngày trước',
      messageCount: 15,
    },
  ];
